...
const UploadFile: React.FC<UploadFileProps> = ({ setStep, setFile, setSelectedModel }) => {
  ...
  return (
    <div className="p-8 px-20 bg-white shadow-lg rounded-xl w-full max-w-3xl text-center">
      ...
      <button
        ...
        className="mt-6 px-6 py-3 font-medium text-white rounded-lg shadow-md transition duration-300 bg-blue-500 hover:bg-blue-600"
      >
        Upload
      </button>
    </div>
